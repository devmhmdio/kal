...
//           return <pre className={styles.preview}>{this.state.src}</pre>;
...
//           />;
//         } else {
//           return <pre className={styles.preview}>no preview</pre>;
//         }
//       } else {
//         return null;
//       }
...
//     const dragClasses = [styles.fileDrag, this.state.hoverState].join(" ").trim();
//        const fileExt =()=> {
//       if (this.state.fileList.length === 1) {
//         if (this.state.fileList[0].type) {
//          return  `.${getExtFromType(this.state.fileList[0].type)}`;
//         } else {
//           return `.${getExtFromName(this.state.fileList[0].name)}`;
//         }
//       } else {
//         return null;
//       }
...
//     const extTail = ()=> {
//       if (fileExt) {
//         return <span className={styles.fileExt}>{fileExt}</span>;
//       } else {
//        return  null;
//       }
//     };
//     const fileNames = ()=> {
//       if (this.state.fileList.length > 1) {
//         return `${this.state.fileList.length} Files`;
//       } else if (this.state.fileList.length === 1) {
//         return this.state.fileList[0].name.replace(fileExt, "");
//       } else {
